  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
      ...
      <button
        ...
        className={cn(
          "group flex w-full items-center justify-between gap-3 rounded-xl border px-3 py-2 text-left transition duration-200 hover:bg-(--surface-soft) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--primary-color)/50 theme-surface theme-text",
      ...
      >
        <span className="flex min-w-0 items-center gap-3">
          ...
          <span className="min-w-0">
            <span className={cn("block truncate text-sm font-medium", compact && "text-xs tracking-[0.18em]")}>
              {compact ? activeOption.shortLabel : t(`locales.${activeOption.code}`)}
            </span>
          </span>
        </span>
      ...
      {isOpen && (
        ...
        >
          <div role="listbox" aria-label={t("common.language")} className="flex flex-col gap-1">
            {localeOptions.map((option) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex w-full items-center gap-3 rounded-lg px-3 py-2 text-left transition duration-200",
                    isActive
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block truncate text-sm font-medium">{t(`locales.${option.code}`)}</span>
                  </span>
